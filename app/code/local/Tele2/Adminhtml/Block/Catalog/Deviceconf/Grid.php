...
class Tele2_Adminhtml_Block_Catalog_Deviceconf_Grid extends Mage_Adminhtml_Block_Catalog_Product_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (Mage::helper('catalog')->isModuleEnabled('Tele2_Feed')) {
            $this->addRssList('feed/products/deviceconf', Mage::helper('catalog')->__('Feed for configurable devices'));
        }
        return $this;
    }
