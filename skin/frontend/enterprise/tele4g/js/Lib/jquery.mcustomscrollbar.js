            ...
            return this.each(function () {
                ...
                if (!$(document).data("mCS-is-touch-device")) { /*not touch device - apply custom scrollbars functionality*/
                    ...
                    if (options.horizontalScroll) {
                        ...
                        mCSB_dragger.data("minDraggerHeight", mCSB_dragger.innerHeight());
                    }
        ...
        update: function () {
            ...
            if ($this.data("horizontalScroll")) {
                ...
                var mCSB_buttonUp = mCSB_scrollTools.children(".mCSB_buttonUp"),
					...
					mCustomScrollBoxH = mCustomScrollBox.innerHeight(),
            ...
            if (mCSB_containerH > mCustomScrollBoxH && !$this.data("horizontalScroll") && !$(document).data("mCS-is-touch-device")) { /*content needs vertical scrolling*/
                ...
                var mCSB_draggerContainerH = mCSB_draggerContainer.innerHeight();
                ...
                if ($this.data("autoDraggerLength")) {
                    ...
                    mCSB_dragger.children(".mCSB_dragger_bar").css({ "line-height": mCSB_dragger.innerHeight() + "px" });
                }
                var mCSB_draggerH = mCSB_dragger.innerHeight(),
        ...
        scrolling: function (mCustomScrollBox, mCSB_container, mCSB_draggerContainer, mCSB_dragger, mCSB_buttonUp, mCSB_buttonDown, mCSB_buttonLeft, mCSB_buttonRight) {
            ...
            mCSB_draggerContainer.unbind("click").bind("click", function (e) {
                ...
                if ($this.data("horizontalScroll")) {
                    ...
                    if (mouseCoord < mCSB_dragger.position().top || mouseCoord > (mCSB_dragger.position().top + mCSB_dragger.innerHeight())) {
                        var scrollToPos = mouseCoord;
                        if (scrollToPos >= mCSB_draggerContainer.innerHeight() - mCSB_dragger.innerHeight()) { /*max dragger position is bottom*/
                            scrollToPos = mCSB_draggerContainer.innerHeight() - mCSB_dragger.innerHeight();
                        }
            ...
            if ($this.data("mouseWheel")) {
                ...
                mCustomScrollBox.unbind("mousewheel").bind("mousewheel", function (event, delta) {
                    ...
                    if ($this.data("horizontalScroll")) {
                        ...
                        var mCSB_draggerContainerH = mCSB_draggerContainer.innerHeight(),
							mCSB_draggerH = mCSB_dragger.innerHeight();
                ...
                if ($this.data("scrollButtons-scrollType") === "pixels") { /*scroll by pixels*/
                    ...
                    if ($this.data("horizontalScroll")) {
                        ...
                        var mCSB_buttonScrollDown,
							mCSB_draggerContainerH = mCSB_draggerContainer.innerHeight(),
							mCSB_draggerH = mCSB_dragger.innerHeight();
                ...
                if (focusedElem.is("input,textarea,select,button,a[tabindex],area,object")) {
                    if ($this.data("horizontalScroll")) {
                        ...
                        if (mCSB_containerY + focusedElemY >= 0 && mCSB_containerY + focusedElemY <= mCustomScrollBoxH - focusedElemH) {
                            ...
                            if (moveDragger >= mCSB_draggerContainer.innerHeight() - mCSB_dragger.innerHeight()) { /*max dragger position is bottom*/
                                moveDragger = mCSB_draggerContainer.innerHeight() - mCSB_dragger.innerHeight();
                            }
            ...
            if (scrollTo) {
                if (typeof (scrollTo) === "number") { /*if integer, scroll by number of pixels*/
                    ...
                    if (scrollTo === "top") { /*scroll to top*/
                        ...
                        target = mCSB_container.outerHeight() - mCustomScrollBox.innerHeight();
        ...
        callbacks: function (mCustomScrollBox, mCSB_container) {
            ...
            if (!$(document).data("mCS-is-touch-device")) { /*not touch device*/
                if ($this.data("horizontalScroll")) {
                    ...
                    if (mCSB_containerY < 0 && mCSB_containerY <= mCustomScrollBox.innerHeight() - mCSB_container.outerHeight() + $this.data("onTotalScroll-Offset")) {
                        $this.data("onTotalScroll-Callback").call();
                    } else {
                        $this.data("onScroll-Callback").call();
                    }
                ...
                if ($this.data("horizontalScroll")) {
                    ...
                    if (mCustomScrollBoxY > 0 && mCustomScrollBoxY >= mCSB_container.outerHeight() - $this.innerHeight() - $this.data("onTotalScroll-Offset")) {
                        $this.data("onTotalScroll-Callback").call();
                    } else {
                        $this.data("onScroll-Callback").call();
                    }
